# autoSchema Terms and Conditions
...
**注意：**有关我们如何收集和使用您的数据的详细信息，请参阅我们的[隐私政策]。
...
通過使用該應用程序，您承認結構化數據的實施受到我們無法控制的各種因素的影響，包括搜索引擎算法，這可能會影響SEO和商業結果。
...
Odpovídáte za údržbu a správu svého obchodu Shopify, včetně jakýchkoliv problémů způsobených používáním aplikace.
...
De applicatie werkt uitsluitend met gestructureerde gegevens en verandert niets aan uw producten, pagina’s of SEO-instellingen. De dienst is bedoeld om de zichtbaarheid in zoekmachines te verbeteren door de juiste implementatie van gestructureerde gegevens.
...
De kosten kunnen worden gewijzigd en we zullen u van tevoren op de hoogte stellen van wijzigingen. Als u niet akkoord gaat met de gewijzigde kosten, kunt u zich op elk moment afmelden.
...
### 7. Palvelun käytettävyys ja huolto
...
Non venderemo, condivideremo o affitteremo i tuoi dati a terze parti, salvo che sia necessario per fornire i nostri servizi o richiesto dalla legge.
...
Ved å bruke AutoSchema godtar du at søkemotorresultater kan påvirkes av faktorer utenfor vår kontroll, som algoritmeendringer i søkemotorer.
...
### 3. Odpowiedzialność użytkownika i konto
...
Korzystając z AutoSchema, rozumiesz, że wyniki wyszukiwania mogą zostać wpływają przez czynniki poza naszą kontrolą, takie jak zmiany algorytmów wyszukiwarek.
...
### 3. Responsabilidade do Usuário e Conta
...
Ao usar o AutoSchema, você entende que os resultados de busca podem ser afetados por fatores além do nosso controle, como mudanças nos algoritmos dos mecanismos de busca.
...
### 3. Responsabilidade do Utilizador e Conta
...
Ao usar o AutoSchema, entende que os resultados de pesquisa podem ser afetados por fatores além do nosso controle, como alterações nos algoritmos dos motores de busca.
...
### 3. Responsabilidad del Usuario y Cuenta
...
Al utilizar AutoSchema, comprende que los resultados en los motores de búsqueda pueden verse afectados por factores fuera de nuestro control, como cambios en los algoritmos de los motores de búsqueda.
...
Denna app påverkar endast strukturerad data och gör inga ändringar i produkter, sidor eller SEO-inställningar. Syftet med tjänsten är att förbättra synligheten i sökmotorer genom att korrekt implementera strukturerad data.
...
Genom att använda AutoSchema förstår du att resultat i sökmotorer kan påverkas av faktorer utanför vår kontroll, såsom ändringar i sökmotorernas algoritmer.
...
### 3. ความรับผิดชอบของผู้ใช้และบัญชี
...
เมื่อคุณติดตั้ง AutoSchema คุณจะให้สิทธิ์แอปในการเข้าถึงส่วนหัวของร้านค้าของคุณเพื่อเพิ่มข้อมูลที่มีโครงสร้างและลบข้อมูลซ้ำ สิทธิ์การเข้าถึงนี้จำเป็นสำหรับการทำงานของแอป แอปจะไม่แก้ไขส่วนอื่นใดของร้านค้า

โปรดตรวจสอบให้แน่ใจว่าการตั้งค่าการเข้าถึงถูกต้องเพื่อให้แอปทำงานได้อย่างถูกต้อง

### 5. ความเป็นส่วนตัวและการใช้ข้อมูล
เรามุ่งมั่นในการปกป้องความเป็นส่วนตัวของคุณและข้อมูลของผู้ใช้ โดยการใช้ AutoSchema คุณยอมรับการเก็บรวบรวมและการประมวลผลข้อมูลที่เกี่ยวข้องกับผลิตภัณฑ์ เนื้อหา และการใช้ร้านค้า ตามที่ระบุใน [นโยบายความเป็นส่วนตัวของเรา]

เราไม่ขายหรือแบ่งปันข้อมูลของคุณกับบุคคลที่สาม ยกเว้นเมื่อจำเป็นสำหรับการให้บริการหรือเมื่อกฎหมายกำหนด

### 6. เนื้อหาของผู้ใช้
คุณเป็นเจ้าของเนื้อหาทั้งหมดที่อัปโหลดไปยังร้านค้าของคุณบน Shopify รวมถึงคำบรรยายสินค้าภาพถ่ายและข้อมูลเมตา AutoSchema ใช้เนื้อหานี้ในการเพิ่มและอัปเดตข้อมูลที่มีโครงสร้าง

โดยการใช้ AutoSchema คุณให้สิทธิ์ไม่ผูกขาดและฟรีในการใช้เนื้อหาของคุณเพื่อให้บริการนี้

### 7. ความพร้อมใช้งานของบริการและการบำรุงรักษา
เราให้ความสำคัญในการรักษาบริการให้มีความน่าเชื่อถือ แต่การหยุดทำงานอาจเกิดขึ้นได้เนื่องจากการบำรุงรักษาหรือปัญหาทางเทคนิคที่ไม่คาดคิด เราไม่สามารถรับประกันได้ว่าบริการจะพร้อมใช้งานตลอดเวลา และเราไม่รับผิดชอบต่อการสูญเสีย ความเสียหาย หรือความไม่สะดวกที่เกิดจากการหยุดทำงานของบริการ

### 8. การชำระเงินและค่าธรรมเนียม
AutoSchema เป็นบริการที่มีค่าธรรมเนียมและคุณยอมรับค่าธรรมเนียมที่ระบุใน Shopify App Store ค่าธรรมเนียมจะถูกเรียกเก็บตามช่วงเวลาการชำระเงินที่เลือก

ค่าธรรมเนียมอาจมีการเปลี่ยนแปลง แต่เราจะแจ้งให้คุณทราบล่วงหน้า หากคุณไม่ยอมรับค่าธรรมเนียมใหม่ คุณสามารถยกเลิกการสมัครได้ทุกเมื่อ

### 9. ข้อจำกัดความรับผิดชอบ
ตามขอบเขตสูงสุดที่กฎหมายอนุญาต AutoSchema และบริษัทในเครือ ผู้ให้บริการ และพนักงานของเราไม่รับผิดชอบต่อการสูญเสียหรือความเสียหายที่เกิดจากการใช้ AutoSchema หรือบริการนี้ รวมถึงแต่ไม่จำกัดเพียง:
- การสูญเสียการจัดอันดับ SEO หรือการมองเห็นในเครื่องมือค้นหา
- การสูญเสียยอดขายหรือรายได้
- ผลกระทบที่เป็นลบต่อประสิทธิภาพของร้านค้า

โดยการใช้ AutoSchema คุณเข้าใจว่าผลลัพธ์ในเครื่องมือค้นหาอาจได้รับผลกระทบจากปัจจัยที่อยู่นอกเหนือการควบคุมของเรา เช่น การเปลี่ยนแปลงในอัลกอริธึมของเครื่องมือค้นหา

### 10. ไม่มีการรับประกันผลลัพธ์
AutoSchema ถูกออกแบบมาเพื่อช่วยในด้าน SEO โดยการเพิ่มข้อมูลที่มีโครงสร้าง แต่เราไม่รับประกันผลลัพธ์ที่เฉพาะเจาะจง เช่น การจัดอันดับที่ดีขึ้นในเครื่องมือค้นหาหรือยอดขายที่เพิ่มขึ้น SEO ขึ้นอยู่กับปัจจัยหลายอย่างที่อยู่นอกเหนือการควบคุมของเรา

คุณเข้าใจและยอมรับว่า AutoSchema ไม่รับประกันผลลัพธ์เฉพาะเจาะจง

### 11. การยกเว้นความรับผิดชอบ
คุณยอมรับการปลดปล่อย AutoSchema บริษัทในเครือ พนักงาน และตัวแทนจากความรับผิดชอบต่อการเรียกร้อง การสูญเสีย ความเสียหาย ความรับผิดหรือค่าใช้จ่ายใดๆ ที่เกิดจากการใช้ AutoSchema หรือการละเมิดข้อกำหนดเหล่านี้

### 12. การยกเลิก
คุณสามารถยกเลิกการสมัครสมาชิก AutoSchema ได้ทุกเมื่อผ่านแผงควบคุมของ Shopify หลังจากการยกเลิก คุณจะสูญเสียการเข้าถึงแอปและบริการ

เราอาจสิ้นสุดหรือระงับการเข้าถึง AutoSchema หากเราพบว่าคุณละเมิดข้อกำหนดหรือด้วยเหตุผลอื่น

### 13. การเปลี่ยนแปลงข้อกำหนด
ข้อกำหนดเหล่านี้อาจมีการเปลี่ยนแปลงได้ทุกเมื่อ การเปลี่ยนแปลงจะมีผลบังคับใช้หลังจากการเผยแพร่ในหน้านี้ การใช้ AutoSchema ต่อหลังจากการเปลี่ยนแปลงข้อกำหนดแสดงว่าคุณยอมรับข้อกำหนดที่ปรับปรุงแล้ว

### 14. กฎหมายที่บังคับใช้
ข้อกำหนดเหล่านี้จะได้รับการควบคุมและตีความตามกฎหมายของนิวซีแลนด์ โดยไม่คำนึงถึงหลักการขัดแย้งของกฎหมาย

# Turkish <a name="turkish"></a>
## Şartlar ve Koşullar

### 1. Şartların Kabulü
AutoSchema'yı kullanarak bu şartları kabul etmiş olursunuz. Eğer bu şartları kabul etmiyorsanız, uygulamayı yüklemeyin veya kullanmayın.

### 2. Hizmet Tanımı
AutoSchema aşağıdaki hizmetleri sunmaktadır:
- **Yapılandırılmış veri ekleme**: Schema.org yapılandırılmış veri etiketlerinin otomatik olarak mağazanızın başlığına eklenmesi.
- **Yinelenen verilerin kaldırılması**: Önceden eklenen yinelenen yapılandırılmış verilerin otomatik olarak tespit edilip kaldırılması.
- **Diğer alanlara müdahale yok**: AutoSchema, mağazanızın içerik, tasarım veya fonksiyonellik gibi diğer alanlarına müdahale etmez.

Bu hizmet yalnızca yapılandırılmış verilerle ilgilidir ve ürünleri, sayfaları veya SEO ayarlarını değiştirmez. Hizmetin amacı, yapılandırılmış verilerin doğru şekilde uygulanmasını sağlayarak arama motorlarında görünürlüğü artırmaktır.

### 3. Kullanıcı ve Hesap Sorumluluğu
AutoSchema'yı kullanabilmek için aktif bir Shopify mağazanızın olması gerekir. Uygulamayı yükleyip kullanarak, aşağıdaki sorumlulukları kabul etmiş olursunuz:
- AutoSchema aracılığıyla gerçekleştirilen tüm işlemlerden sorumlu olmak.
- Gerekli olduğunda doğru ve güncel bilgi sağlamak.
- Shopify mağazanız ve AutoSchema'yı kullanırken geçerli tüm yasalara uymak.

Mağazanızın yönetimi ve bakımı siz sorumlusunuz ve uygulamayı kullanmaktan kaynaklanan tüm sorunlardan siz sorumlusunuz.

### 4. Kurulum ve Erişim
AutoSchema'yı yüklediğinizde, uygulamaya mağazanızın başlık bölümüne yapılandırılmış veri eklemek ve yinelenen verileri kaldırmak için erişim izni vermiş olursunuz. Bu erişim, uygulamanın doğru şekilde çalışabilmesi için gereklidir. Uygulama mağazanızın diğer bölümlerine müdahale etmez.

Erişim ayarlarınızın doğru yapılandırıldığından emin olun, böylece uygulama doğru şekilde çalışır.

### 5. Gizlilik ve Veri Kullanımı
Gizliliğinizi ve kullanıcı verilerini korumaya kararlıyız. AutoSchema'yı kullanarak, ürünleriniz, içerikleriniz ve mağazanızın kullanımıyla ilgili verilerin toplandığını ve işlendiğini [Gizlilik Politikamız] ile uyumlu olarak kabul edersiniz.

Verilerinizi, hizmeti sağlamak veya yasal gereklilikler nedeniyle başkalarıyla paylaşmamız dışında üçüncü şahıslarla satmayız veya paylaşmayız.

### 6. Kullanıcı İçeriği
Shopify mağazanıza yüklediğiniz tüm içerikler, ürün açıklamaları, görseller ve meta veriler dahil olmak üzere sizin mülkiyetinizdedir. AutoSchema, yapılandırılmış verileri eklemek ve güncellemek için bu içeriği kullanır.

AutoSchema'yı kullanarak, içeriğinizi hizmeti sağlamak amacıyla kullanmamıza ücretsiz ve münhasır olmayan bir lisans verirsiniz.

### 7. Hizmetin Kullanılabilirliği ve Bakım
Hizmeti güvenilir tutmaya çalışıyoruz, ancak bakım veya beklenmedik teknik sorunlar nedeniyle kesintiler olabilir. Hizmetin her zaman kullanılabilir olacağını garanti edemeyiz ve hizmetin kesintiye uğramasından kaynaklanan herhangi bir kayıp, zarar veya rahatsızlıktan sorumlu olmayız.

### 8. Ödemeler ve Ücretler
AutoSchema, ücretli bir hizmettir ve Shopify Uygulama Mağazasında belirtilen ücretleri kabul etmiş olursunuz. Ücretler, seçilen ödeme dönemine göre alınır.

Ücretler değişebilir, ancak size önceden bildirilecektir. Yeni ücretleri kabul etmiyorsanız, aboneliğinizi istediğiniz zaman iptal edebilirsiniz.

### 9. Sorumluluğun Sınırlandırılması
Kanunun izin verdiği azami ölçüde, AutoSchema ve bağlı kuruluşları, hizmeti kullanmanızdan kaynaklanan herhangi bir kayıp veya zarardan sorumlu değildir, bunlara aşağıdakiler dahildir ancak bunlarla sınırlı değildir:
- SEO sıralamasında veya arama motorlarında görünürlük kaybı
- Satış veya gelir kaybı
- Mağaza performansındaki olumsuz etki

AutoSchema'yı kullanarak, arama motorlarındaki sonuçların bizim kontrolümüzde olmayan faktörlerden etkilenebileceğini anlıyorsunuz.

### 10. Sonuçların Garantisi Yok
AutoSchema, yapılandırılmış veri ekleyerek SEO'yu iyileştirmeyi amaçlar, ancak belirli bir sonuç garanti etmez, örneğin daha iyi arama motoru sıralamaları veya artan satışlar. SEO, bizim kontrolümüzde olmayan birçok faktöre bağlıdır.

AutoSchema'nın belirli sonuçlar garanti etmediğini anlıyor ve kabul ediyorsunuz.

### 11. Sorumluluğun Sınırlandırılması
AutoSchema'yı kullanarak, AutoSchema'yı, bağlı kuruluşlarını, çalışanlarını ve temsilcilerini AutoSchema'yı kullanmanızdan veya bu şartları ihlal etmenizden kaynaklanan herhangi bir iddia, kayıp, zarar, sorumluluk veya maliyetten dolayı sorumlu tutmaktan muaf tutuyorsunuz.

### 12. İptal
AutoSchema aboneliğinizi Shopify yönetim panelinden istediğiniz zaman iptal edebilirsiniz. İptal ettikten sonra uygulamaya ve hizmete erişiminiz sona erer.

Herhangi bir şart ihlali veya başka nedenlerle AutoSchema'ya erişiminizi sonlandırma veya askıya alma hakkımız saklıdır.

### 13. Şartlarda Değişiklik
Bu şartlar her zaman değiştirilebilir. Değişiklikler, bu sayfada yayınlandığı anda geçerli olur. Şartlarda yapılan değişikliklere devam ederek, güncellenmiş şartları kabul etmiş olursunuz.

### 14. Uygulanabilir Hukuk
Bu şartlar, Yeni Zelanda yasalarına göre yönetilecek ve yorumlanacaktır, hukuk çatışması ilkeleri dikkate alınmaksızın.

# French <a name="french"></a>
## Termes et Conditions

### 1. Acceptation des Conditions
En utilisant AutoSchema, vous acceptez ces termes. Si vous n'acceptez pas ces termes, veuillez ne pas installer ou utiliser cette application.

### 2. Description du Service
AutoSchema fournit les services suivants :
- **Ajout de données structurées** : Ajout automatique des balises de données structurées (Schema.org) dans l'en-tête de votre boutique.
- **Suppression des données dupliquées** : Détection et suppression automatiques des données structurées en double qui ont été ajoutées précédemment.
- **Pas de modification d'autres éléments** : AutoSchema n'apporte aucune modification au contenu, au design ou aux fonctionnalités de votre boutique.

Ce service ne concerne que les données structurées et n'affecte pas vos produits, pages ou paramètres SEO. L'objectif du service est d'améliorer la visibilité dans les moteurs de recherche en veillant à ce que les données structurées soient correctement mises en place.

### 3. Responsabilité de l'Utilisateur et du Compte
Pour utiliser AutoSchema, vous devez disposer d'une boutique active sur Shopify. En installant et en utilisant l'application, vous acceptez de :
- Être responsable de toutes les actions effectuées par l'utilisation d'AutoSchema.
- Fournir des informations exactes et à jour, le cas échéant.
- Respecter toutes les lois applicables lors de l'utilisation de votre boutique Shopify et d'AutoSchema.

Vous êtes responsable de la gestion et de l'entretien de votre boutique Shopify et de tout problème découlant de l'utilisation de l'application.

### 4. Installation et Accès
Lorsque vous installez AutoSchema, vous donnez à l'application l'autorisation d'accéder à l'en-tête de votre boutique pour ajouter des données structurées et supprimer des données en double. Cet accès est nécessaire au bon fonctionnement de l'application. L'application n'affecte aucune autre partie de votre boutique.

Assurez-vous que vos paramètres d'accès sont correctement configurés pour permettre à l'application de fonctionner correctement.

### 5. Confidentialité et Utilisation des Données
Nous nous engageons à protéger votre vie privée et vos données utilisateur. En utilisant AutoSchema, vous acceptez la collecte et le traitement des données relatives à vos produits, contenus et à l'utilisation de votre boutique, conformément à [notre politique de confidentialité].

Nous ne vendons ni ne partageons vos données avec des tiers, sauf si nécessaire pour fournir le service ou lorsque la loi l'exige.

### 6. Contenu de l'Utilisateur
Vous conservez tous les droits sur le contenu que vous téléchargez dans votre boutique Shopify, y compris les descriptions de produits, les images et les métadonnées. AutoSchema utilise ce contenu pour ajouter et mettre à jour les données structurées.

En utilisant AutoSchema, vous nous accordez une licence gratuite et non exclusive pour utiliser votre contenu dans le but de fournir ce service.

### 7. Disponibilité du Service et Maintenance
Nous nous efforçons de maintenir le service fiable, mais des interruptions peuvent survenir en raison de la maintenance ou de problèmes techniques imprévus. Nous ne garantissons pas que le service sera disponible en tout temps et ne sommes pas responsables des pertes, dommages ou inconvénients causés par l'indisponibilité du service.

### 8. Paiements et Frais
AutoSchema est un service payant et vous acceptez les frais indiqués dans le Shopify App Store. Les frais sont facturés en fonction de la période de paiement choisie.

Les frais peuvent être modifiés, mais vous en serez informé à l'avance. Si vous n'acceptez pas les nouveaux frais, vous pouvez annuler votre abonnement à tout moment.

### 9. Limitation de Responsabilité
Dans la mesure maximale autorisée par la loi, AutoSchema et ses sociétés affiliées, prestataires de services et employés ne seront pas responsables des pertes ou dommages résultant de l'utilisation d'AutoSchema ou de ce service, y compris mais sans s'y limiter :
- La perte de classement SEO ou la visibilité dans les moteurs de recherche.
- La perte de ventes ou de revenus.
- Les impacts négatifs sur la performance de la boutique.

En utilisant AutoSchema, vous comprenez que les résultats dans les moteurs de recherche peuvent être influencés par des facteurs échappant à notre contrôle, tels que les changements d'algorithmes des moteurs de recherche.

### 10. Absence de Garantie de Résultats
AutoSchema est conçu pour aider avec le SEO en ajoutant des données structurées, mais nous ne garantissons pas de résultats spécifiques, tels qu'une amélioration des classements dans les moteurs de recherche ou une augmentation des ventes. Le SEO dépend de nombreux facteurs échappant à notre contrôle.

Vous comprenez et acceptez qu'AutoSchema ne garantisse aucun résultat spécifique.

### 11. Exonération de Responsabilité
Vous acceptez d'indemniser et de dégager AutoSchema, ses sociétés affiliées, employés et agents de toute responsabilité en cas de réclamations, pertes, dommages, responsabilités ou frais découlant de l'utilisation d'AutoSchema ou de la violation de ces termes.

### 12. Annulation
Vous pouvez annuler votre abonnement à AutoSchema à tout moment via le panneau d'administration de Shopify. Après l'annulation, vous perdrez l'accès à l'application et aux services.

Nous nous réservons le droit de résilier ou de suspendre l'accès à AutoSchema si nous constatons que vous avez violé ces termes ou pour toute autre raison.

### 13. Modifications des Conditions
Ces conditions peuvent être modifiées à tout moment. Les modifications entreront en vigueur dès leur publication sur cette page. L'utilisation continue d'AutoSchema après les modifications des conditions signifie que vous acceptez les conditions modifiées.

### 14. Droit Applicable
Ces conditions seront régies et interprétées conformément aux lois de la Nouvelle-Zélande, sans tenir compte des principes de conflit de lois.
